...
app.get("/products/:id/edit",(req,res)=>{
  ...
  if(!currentUser){
    ...
    if(filter==1){
      res.render("products/edit/vehicle",{prod:prod});
    }else if(filter==2){
      res.render("products/edit/electronics",{prod:prod});
    }else if(filter==3){
      res.render("products/edit/furniture",{prod:prod});
    }else if(filter==4){
      res.render("products/edit/mobile",{prod:prod});
    }else if(filter==5){
      res.render("products/edit/books",{prod:prod});
    }else if(filter==6){
      res.render("products/edit/other",{prod:prod});
    }else{
      req.flash("error","Something went wrong!!!");
      res.redirect("/products");
    }
